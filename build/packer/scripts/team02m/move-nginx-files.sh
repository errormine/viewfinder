...
sudo cp -v /home/vagrant/team02m-2024/code/nginx/nginx.conf /etc/nginx/
sudo cp -v /home/vagrant/team02m-2024/code/nginx/default /etc/nginx/sites-available/
# This connects the TLS certs built in this script with the instances
sudo cp -v /home/vagrant/team02m-2024/code/nginx/self-signed.conf /etc/nginx/snippets/
